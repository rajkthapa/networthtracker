  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative bg-white rounded-3xl shadow-2xl max-w-md w-full p-8 animate-scale-in">
        <button onClick={onClose} className="absolute top-4 right-4 p-2 rounded-xl hover:bg-surface-100 transition-colors">
        ...
        <div className="text-center mb-6">
          ...
          <h2 className="text-2xl font-bold text-surface-900 mb-2">Upgrade to Pro</h2>
          {feature && (
            <p className="text-sm text-surface-500">
              <span className="font-semibold text-grape-600">{feature}</span> is a Pro feature.
        ...
        <button
          ...
          disabled={loading}
          className="w-full py-3.5 rounded-xl font-semibold text-white bg-gradient-to-r from-grape-500 to-accent-500 hover:shadow-lg transition-all disabled:opacity-50 flex items-center justify-center gap-2"
        >
          {loading ? (
