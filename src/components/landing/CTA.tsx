      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-primary-600 via-grape-600 to-primary-700 p-10 md:p-16 text-center">
          ...
          <div className="relative">
            ...
            <Link
              href="/auth/signup"
              className="group inline-flex items-center gap-2 px-8 py-4 bg-th-card text-primary-300 font-semibold rounded-2xl hover:bg-th-card/90 transition-all shadow-xl text-base"
            >
              Create Free Account
